"""Music-store agent with routing-only Semantic Router middleware."""
...
from middleware import SemanticRouterMiddleware
...
graph = create_agent(
    ...
    middleware=[
        SemanticRouterMiddleware(
            models=models,
            router_url=os.getenv("SEMANTIC_ROUTER_API_URL", "http://127.0.0.1:8080"),
        )
    ],
